...
import { OrbitControls, Preload,
    useGLTF  // extension qui permet d'importer des modèles 3D
...
const Computers = ({ isMobile }) => {
    ...
    // Création du composant qui va contenir le modèle 3D
  ...
  return (
      ...
      >
        <Suspense fallback={<CanvasLoader />}>
          <OrbitControls   // permet de faire tourner la caméra
              enableZoom={false}
